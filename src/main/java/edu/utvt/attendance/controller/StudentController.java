...
public class StudentController {
	...
	/*
	@GetMapping
	public ResponseEntity<Page<Student>> getMethodName(@RequestParam(value ="page", defaultValue= "0")Integer param, @RequestParam(value = "size", defaultValue="50") Integer size) {
